...
/*   Updated: 2024/02/12 22:34:05 by lquehec          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	while (save[fd][string.len])
		string.len++;
	ft_strlcpy_gnl(string.content, save[fd], string.len + 1);
	...
	ft_strlcpy_gnl(save[fd], \
		string.content + line_len, string.len - line_len + 1);
